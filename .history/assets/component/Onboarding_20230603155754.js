    ...
    <View style={styles.container}>
      ...
      <View>
        ...
        <View style={styles.buttons}>
          <Button mode="contained" style={{width: 150}} > <Text style={{color:'white'}} >Create Account</Text></Button>
          <Button mode="contained" style={{width: 150}}> <Text style={{color:'white'}}>Log In</Text></Button>
        </View>
      </View>
    </View>
  );
